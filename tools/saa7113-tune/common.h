...
inline constexpr std::uint8_t kSaaWpoff = 0x10;  // reg 0x03 bit 4: 1 = white-peak detector ignored by AGC
inline constexpr std::uint8_t kSaaHlnrs = 0x40;  // reg 0x03 bit 6: 1 = "reference select" clamping when H unlocked
